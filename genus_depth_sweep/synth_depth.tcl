...
set SWEEP_FOLDER   ${PROJECT_ROOT}/genus_depth_sweep
set OUT_FOLDER     ${PROJECT_ROOT}/outputs/depth
set REPORT_FOLDER  ${PROJECT_ROOT}/reports/depth
set CHKPT_FOLDER   ${PROJECT_ROOT}/chkpts/depth

set LIB_FOLDER /ubc/ece/data/cmc2/kits/GPDK45/gsclib045_all_v4.4/gsclib045/timing
set LIB_FILE   slow_vdd1v0_basicCells.lib

if {[info exists ::env(DEPTH)]} {
    set DEPTH $::env(DEPTH)
} else {
    set DEPTH 8
}
...
set TOP_LEVEL tp_lvl_d${DEPTH}
set RUN_NAME d${DEPTH}_200MHz
...
puts ""
puts "GENUS DEPTH SYNTHESIS COMPLETE"
puts "Top: $TOP_LEVEL"
puts "DEPTH: $DEPTH"
puts "TIMER_WIDTH: 16"
